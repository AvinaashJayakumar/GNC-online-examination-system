        ...
        <div class="modal-body">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="core_id" id="core_id" class="form-control" placeholder="Course id" required="" autocomplete="off"><br>
                    <label>Course</label>
                    <input type="text" name="course_name" id="course_name" class="form-control" placeholder="Input Course" required="" autocomplete="off"><br>
                    <label>Stream</label>
     ...
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
         ...
         <div class="form-group">
                <label>UNIT</label>
                <select name="unit" id="" class="form-control" placeholder="select the unit" autocomplete="off">
