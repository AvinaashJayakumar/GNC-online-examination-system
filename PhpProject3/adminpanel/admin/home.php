   ...
   if($page != '')
   {
     ...
     else if($page == "manage-course")
     {
     	include("pages/manage-course.php");
          ...
          else if($page == "examinee_preview")
     {
      include("pages/preview_questions.php");
     }
     ...
     else if($page == "manage-examinee")
     {
      include("pages/manage-examinee.php");
         ...
         else if($page == "delete-exam1")
     {
      include("pages/delete-exam.php");
     }
...
else if($page == "print-op")
     {
      include("pages/print-op.php");
     }
