...
<form method="post" id="updateExamineeFrm">
     ...
     <div class="form-group">
        <legend>Register Number</legend>
        <input type="number" name="regno" class="form-control" required="" value="<?php echo $selExmne["exmne_regno"]; ?>"/>
     </div>
    ...
    <div class="form-group">
            ...
            <select class="form-control" name="Section" id="Section">
              <option value="<?php echo $selExmne['exmne_section']; ?>"><?php echo $selExmne['exmne_section']; ?></option>
