...
<head>
  ...
  <link rel="stylesheet" href="login-ui/student.css">
  <style>
      /* CSS */
.button-17 {
  align-items: center;
...
<div class="container" id="container">
	<div class="form-container sign-in-container">
		<form method="post" id="examineeLoginFrm" class="login100-form validate-form">
			...
			<button type="submit"  onclick="openFullscreenWindow();">Sign In</button>
		</form>
	</div>
	<div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
				<h1>Hello, Friend!</h1>
				<p>Enter your personal details and start your Examination</p>
				<!-- HTML !-->
<button class="button-17" role="button" onclick="window.location.href = 'login-ui/register.php';">signup</button>
			</div>
		</div>
	</div>
</div>
  <script  src="login-ui/student.js"></script>
  <script>
  function openFullscreenWindow() {
  var w = window.open('home.php', 'Fullscreen Window', 'width=' + screen.width + ',height=' + screen.height + ',left=0,top=0,toolbar=no,location=no,status=no,menubar=no,resizable=no');
  w.focus();
